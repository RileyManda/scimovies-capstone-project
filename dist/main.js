...
var getTvShows = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(genreId) {
    var url, response, allTvShows, sciFiTvShows;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          url = "".concat(_api_config_js__WEBPACK_IMPORTED_MODULE_0__.API_URL, "?q=").concat(genreId);
          _context.prev = 1;
          _context.next = 4;
          return fetch(url);
        case 4:
        ...
        case 9:
          allTvShows = _context.sent;
          sciFiTvShows = allTvShows.slice(0, 30);
          (0,_localStorage_js__WEBPACK_IMPORTED_MODULE_3__.saveListToStorage)(sciFiTvShows);
          (0,_view_domView_js__WEBPACK_IMPORTED_MODULE_1__["default"])(sciFiTvShows);
        ...
        case 16:
          ...
          (0,_utils_showSnackBar_js__WEBPACK_IMPORTED_MODULE_2__["default"])('Error fetching data!', _context.t0);
        case 19:
        case "end":
...
var displayLikesData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var url, response, data;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          url = "".concat(_api_config_js__WEBPACK_IMPORTED_MODULE_0__.ENV_API).concat(_api_config_js__WEBPACK_IMPORTED_MODULE_0__.APP_ID, "/likes");
          _context.next = 3;
          return fetch(url);
        case 3:
          response = _context.sent;
  ...
  return function displayLikesData() {
    return _ref.apply(this, arguments);
  };
}();
